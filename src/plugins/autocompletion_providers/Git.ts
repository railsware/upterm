...
const addOptions = [
    ...
    longAndShortOption("all", "A").withDescription(`
    ...
    longOption("no-all").withDescription(`
    ...
    longAndShortOption("intent-to-add", "N").withDescription(`
    ...
    longOption("refresh").withDescription("Don't add the file(s), but only refresh their stat() information in the index."),
    longOption("ignore-errors").withDescription(`
    ...
    longOption("ignore-missing").withDescription(`
...
const commitOptions = [
    longAndShortOption("message").withDescription("Use the given <msg> as the commit message. If multiple -m options are given, their values are concatenated as separate paragraphs."),
];

const pushOptions = [
    longOption("force-with-lease"),
];
