...
LAST_DRAFT_ID=$(curl "https://$GH_TOKEN:x-oauth-basic@api.github.com/repos/vshatskyi/black-screen/releases" | python -c "import json,sys; array=json.load(sys.stdin); print array[0]['id'];")
