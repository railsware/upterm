...
var Executable = (function () {
    ...
    Executable.prototype.getSuggestions = function (prompt) {
        return new Promise(function (resolve) {
            if (prompt.getWholeCommand().length > 1) {
                return resolve([]);
            }
            Utils_1.default.getExecutablesInPaths().then(function (executables) {
                var lastArgument = prompt.getLastArgument();
                var all = _.map(executables, function (executable) {
                    return {
                        value: executable,
